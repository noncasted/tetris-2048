...
namespace VContainer.Unity
{
    ...
    public static class ContainerBuilderUnityExtensions
    {
            ...
            where T : ComponentSystemBase
        {
            ...
            return services.RegisterComponent(system)
        ...
        {
            services.Register<WorldConfigurationHelper>(lifetime)
                .WithParameter(typeof(string), worldName);
            return services.Register(new WorldRegistrationBuilder(worldName, lifetime, configuration));
        }
            ...
            where T : ComponentSystemBase
        {
            ...
            return services.Register(registrationBuilder);
        }
